                ...
                <table class="basic_write">
                    ...
                    <colgroup>
					   ...
					   <tr>
                        ...
                        <td><input type="text" title="제목" name="title" id="title" class="add_txt"  placeholder="제목 *" 
                          value="${vo.title}"></td>
                    </tr>
                    <tr>
                        <th>작성자<span class="star">*</span></th>
                        <td><input type="text" title="성명" name="writer" id="writer" class="name_txt" placeholder="성명 *"
                        value="${vo.writer}"></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td >
                           <textarea name="content" id="content" cols="30" rows="10" style="width:100%" >
                             ${vo.content}</textarea>
                        </td>
                    </tr>
